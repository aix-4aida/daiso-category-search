        ...
        while self.is_running:
            try:
                ...
                if r["type"] == "interim":
                    ...
                    # 403 Error (Service Disabled) should trigger fallback
                    if "Service Disabled" in error_msg or "has not been used in project" in error_msg:
                        print(f"⚠️ Google STT Service Disabled (403). Forcing fallback.")
                        needs_fallback = True
