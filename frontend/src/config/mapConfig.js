 ...
 * @param {string} nameOrLocation - Product name or location string (e.g., "10번 매대 (욕실)")
 * @returns {object} Shelf location object with floor, x, y coordinates
 */
export function findProductLocation(nameOrLocation) {
 ...
 * @param {string} shelfId - Shelf ID (e.g., "10", "13")
 * @returns {object} Shelf object or null
 */
