...
│   ├── services/         # Business Logic (Search, STT, Pipeline)
│   ├── search/           # Search Infrastructure (Adapters)
│   ├── stt/              # STT Infrastructure (Adapters)
│   └── database/         # Database & Models
├── frontend/             # Frontend Application
│   ├── kiosk/            # Kiosk UI (Tablet)
│   ├── mobile/           # Mobile AR/Map UI
│   └── assets/           # Shared Resources
└── poc/                  # Proof of Concept & Legacy
    ├── scripts/          # Utility & Maintenance Scripts
    ├── experiments/      # Experiment Logs & Models
    └── ...
```
