...
INPUT_JSON_PATH = os.path.join(BASE_DIR, "backend", "services_kms", "data", "extracted_keywords.json")
OUTPUT_JSON_PATH = os.path.join(BASE_DIR, "backend", "services_kms", "data", "expansion_result.json")
